...
/**
 * SZEREP collection page — identical to the base, but uses a local template that
 * re-adds the collection shortDescription block, which DSpace 10 removed from the
 * base collection-page template.
 */
@Component({
