...
import { getPageInternalServerErrorRoute } from 'src/app/app-routing-paths';
import { ThemedBreadcrumbsComponent } from 'src/app/breadcrumbs/themed-breadcrumbs.component';
import {
  NativeWindowRef,
  NativeWindowService,
} from 'src/app/core/services/window.service';
import { ThemedFooterComponent } from 'src/app/footer/themed-footer.component';
import { ThemedHeaderNavbarWrapperComponent } from 'src/app/header-nav-wrapper/themed-header-navbar-wrapper.component';
...
import { NotificationsBoardComponent } from 'src/app/shared/notifications/notifications-board/notifications-board.component';
import { CSSVariableService } from 'src/app/shared/sass-helper/css-variable.service';
import { SystemWideAlertBannerComponent } from 'src/app/system-wide-alert/alert-banner/system-wide-alert-banner.component';

import { ThemedAdminSidebarComponent } from '../admin/admin-sidebar/admin-sidebar.component';
