...
/**
 * SZEREP community page — identical to the base, but uses a local template that
 * re-adds the community shortDescription block, which DSpace 10 removed from the
 * base community-page template.
 */
@Component({
